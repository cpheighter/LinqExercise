...
namespace LinqExercise
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            employees.Where(x => x.FirstName.StartsWith('C') || x.FirstName.StartsWith('S')).OrderBy(x => x.FullName).ToList().ForEach(x => Console.WriteLine(x.FullName));
            Console.WriteLine("--------------------------");
            ...
            employees.Append(new Employee() { FirstName = "Franklin", LastName = "Wilson", Age = 44, YearsOfExperience = 20}).ToList().ForEach(x => Console.WriteLine(x.FullName));
